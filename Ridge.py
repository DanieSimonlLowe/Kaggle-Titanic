...
model = BayesSearchCV(estimator=RidgeClassifier(), search_spaces=params, n_jobs=-1, cv=cv, n_iter=50, verbose=3)
model.fit(x, y)
joblib.dump(model, 'C:\\Users\\Danie\\Desktop\\work\\kaggle\\titanic\\ridge_bayes_search.pkl')
